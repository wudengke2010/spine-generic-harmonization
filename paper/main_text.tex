...
Third, the Pareto frontier between decontamination and preservation is reproducible across cohorts and persisted under the reduced-imbalance and true-equal-$n$ subsample analyses (Design C; Section~3.5), indicating that the preservation hierarchy tracks correction depth rather than the dataset's vendor imbalance. The frontier should nonetheless be read as a descriptive characterisation of this dataset's structure rather than a universal method ranking, and the decontamination--preservation trade-off it visualises remains a useful framing for method selection.
