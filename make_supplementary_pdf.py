...
pdf.multi_cell(page_w, 5, "1 Department of Emergency Surgery, Changsha Hospital of Traditional Chinese Medicine, Changsha, China", align='C')
pdf.multi_cell(page_w, 5, "2 Department of Orthopedics, Xiangya Hospital, Central South University, Changsha, China", align='C')
pdf.ln(3)
pdf.set_font('Helvetica', 'I', 9)
pdf.cell(page_w, 5, "* Corresponding author: Dengke Wu (wudengke@csu.edu.cn)", align='C', new_x="LMARGIN", new_y="NEXT")
pdf.ln(15)
